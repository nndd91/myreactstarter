...
2. Upload build folder that was generated
Open google cloud shell
3. run command `gsutil rsync -r gs://omoidasuapp ./omoidasuapp` to copy folder from bucket to hosting server
4. cd into omoidasuapp and run `gcloud app deploy`
